...
public class ConvertMealToPlan {
    public static PlanDto getMealPlannerFromMealAndDate(MealDto mealDto, String date, int dayOfWeek) {
    ...
    public static MealDto getMealFromMealPlanner(PlanDto planDto){
